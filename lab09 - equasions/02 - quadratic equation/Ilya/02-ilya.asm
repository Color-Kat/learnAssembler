...
.data
    fio db "Нурмухамедов Илья Дмитриевич", 0
...
main proc
    ...
    fn MessageBox, 0, addr fio, "Фамилия имя отчество", MB_OK
    ...
    ; В остальных случайх - это квадратное уравнение, решаем его через дискирминант
